<div class="main-content" id="page_div">
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li><a href="javascript:void(0)" onclick="loadPage('index.php/sys_module')">模块管理</a></li>
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" id="validation-form" method="post" role="form">
                        <div class="form-group">
                            ...
                            <div class="form-group <?php if (!empty($entity['module_parent_id'])){echo "hidden";}?>">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                   for="module_icon">模块图标:</label>

                            <div class="col-xs-12 col-sm-6">
                                <div class="clearfix">
                                    <input type="text" name="module_icon" id="module_icon" class="col-xs-12 col-sm-6 " value="<?php echo @$entity['module_icon']; ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group <?php if (empty($entity['module_parent_id'])){echo "hidden";}?>">
                        ...
                        <div class="clearfix ">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                &nbsp; &nbsp; &nbsp;
                                <a class="btn btn-xs" href="javascript:void(0)" onclick="loadPage('index.php/sys_module')">
