<div class="main-content" id="page_div">
    ...
    <script>
        function changePermission(cb){
            ...
            $.get("index.php/sys_group_permission/change?module_id="+cb.value+"&flag="+(cb.checked?1:0),
    ...
    <div class="page-content">
        <div class="page-header">
            <div class="row">
                <div class="col-xs-12">
                    <button id="sort_save" href="javascript:void(0)" class="btn btn-pink btn-xs " onclick="loadPage('index.php/sys_user_group/index')">
