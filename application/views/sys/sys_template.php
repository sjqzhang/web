...
<div class="main-content" id="page_div">
    ...
    <div class="page-content">
	  ...
	  .modal-dialog{
        ...
        <script src="resources/sys/js/sys_template.js"></script>       
        ...
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="id"></label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input aria-invalid="false" aria-required="false" name="id" id="id" class="col-xs-12 col-sm-9 valid " type="text"/>
            </div>
        </div>
    </div>    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="name">名称</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input aria-invalid="false" aria-required="false" name="name" id="name" class="col-xs-12 col-sm-9 valid " type="text"/>
            </div>
        </div>
    </div>    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="db">数据库</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix">
                <input aria-invalid="false" aria-required="false" name="db" id="db" class="col-xs-12 col-sm-9 valid " type="text"/>
            </div>
        </div>
    </div>   
	<!--
	<div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="ctrl">控制器</label>
        <div class="col-xs-12 col-sm-9">
        ...
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="model">模型</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix" style="border:1px solid #ccc">
        ...
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="views">视图</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix" style="border:1px solid #ccc">
        ...
        <label class="control-label col-xs-12 col-sm-2 no-padding-right" for="js">JS</label>
        <div class="col-xs-12 col-sm-9">
            <div class="clearfix" style="border:1px solid #ccc">
                <textarea name="js" id="js" mode="javascript" class="code"></textarea>
            </div>
        </div>
    </div>
	-->
 ...
 <ul class="nav nav-tabs" id="myTab">
      ...
      $(function () {
        ...
        $('#myTab a').click(function (e) {
		  ...
		  reReportTemplate._editor[id].setSize('',500);
